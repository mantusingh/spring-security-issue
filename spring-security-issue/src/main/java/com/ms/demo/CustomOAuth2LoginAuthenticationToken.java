...
public class CustomOAuth2LoginAuthenticationToken extends AbstractAuthenticationToken {

  private static final long serialVersionUID = SpringSecurityCoreVersion.SERIAL_VERSION_UID;

  private SkyUser principal;
   ...
   */
  public CustomOAuth2LoginAuthenticationToken(ClientRegistration clientRegistration,
   ...
   */
  public CustomOAuth2LoginAuthenticationToken(ClientRegistration clientRegistration,
      OAuth2AuthorizationExchange authorizationExchange, SkyUser principal,
